package com.example.gpspraktek
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResults(requestCode: Int, permissions:
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            ActivityCompat.requestDragAndDropPermissions(this,
        ...
        else
        {
            ...
            btn_start_update.setOnClickListener (View.OnClickListener {
                if
                    ...
                    ActivityCompat.checkSelfPermission(this@MainActivity, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_DENIED)
                {
            ...
            btn_stop_update.setOnClickListener {
                if
                    ...
                    ActivityCompat.checkSelfPermission(
                        this@MainActivity, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED)
                {
                    ActivityCompat.requestPermissions(this@MainActivity, arrayOf(android.Manifest.permission.ACCESS_FINE_LOCATION), REQUEST_CODE)
